...
<head>
      ...
      <title>Запчасти: педали</title>
      <meta name="description" content="Продажа велосипедов" />
      <meta name="keywords" content="запчасти, педали, продажа" />
...
?>
       ...
       <div class="site_content">
        <h2 class="name_page">Педали для велосипеда</h2>
            <div class="text_description"><p>Удобный педаляж - основа основ в велоспорте. Педали для велосипеда необходимо выбирать с учетом нескольких факторов. Несомненно, главным образом на это влияет стиль катания. Разработчики педалей учитывают множество параметров при создании педалей. Нога велосипедиста должна удобно фиксироваться.</p>
            </div>
            <div class="katalog">
                  <table class="table_katalog">
                        ...
                        if(isset($_POST['delete']))
                            ...
                            $result = mysqli_query($connection,"SELECT * FROM `products` WHERE `podcategories` = '14';");
                            $i=2;
