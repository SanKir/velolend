...
<head>
      ...
      <title>Запчасти: амортизаторы</title>
      <meta name="description" content="Продажа велосипедов" />
      <meta name="keywords" content="запчасти, амортизаторы, продажа" />
...
?>
       ...
       <div class="site_content">
        <h2 class="name_page">Амортизаторы для велосипеда</h2>
            <div class="text_description"><p>Для превращения механической энергии в тепловую на велосипедах служит такое устройство как амортизатор. Во время катания по пересеченной местности либо проселочной дороге он будет гасить колебания от ударов и скачков, которые действуют на раму. Амортизаторы для велосипеда часто применяют совместно с пружинами, рессорами, подушками или торсионами.</p>
            </div>
            <div class="katalog">
                  <table class="table_katalog">
                        ...
                        if(isset($_POST['delete']))
                            ...
                            $result = mysqli_query($connection,"SELECT * FROM `products` WHERE `podcategories` = '9';");
                            $i=2;
