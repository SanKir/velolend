...
<head>
      ...
      <title>Экипировка: шлемы</title>
      <meta name="description" content="Продажа велосипедов" />
      <meta name="keywords" content="экипировка, шлемы, продажа" />
...
?>
       ...
       <div class="site_content">
        <h2 class="name_page">Шлемы для велосипеда</h2>
            <div class="text_description"><p>От падений и травм не застрахован никто. Мы за безопасную езду! Поэтому предлагаем вам приобрести шлемы, изготовленные из высокопрочного пластика, они имеют обтекаемую форму, которая будто «разрезает» воздух. Множество видов и типов шлемов помогут вам подобрать самый оптимальный вариант.</p>
            </div>
            <div class="katalog">
                  <table class="table_katalog">
                        ...
                        if(isset($_POST['delete']))
                            ...
                            $result = mysqli_query($connection,"SELECT * FROM `products` WHERE `podcategories` = '18';");
                            $i=2;
