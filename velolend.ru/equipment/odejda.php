...
<head>
      ...
      <title>Экипировка: одежда</title>
      <meta name="description" content="Продажа велосипедов" />
      <meta name="keywords" content="экипировка, одежда, продажа" />
...
?>
       ...
       <div class="site_content">
        <h2 class="name_page">Одежда</h2>
            <div class="text_description"><p>Удобная и практичная одежда для быстрой езды на велосипеде.</p>
            </div>
            <div class="katalog">
                  <table class="table_katalog">
                        ...
                        if(isset($_POST['delete']))
                            ...
                            $result = mysqli_query($connection,"SELECT * FROM `products` WHERE `podcategories` = '16';");
                            $i=2;
